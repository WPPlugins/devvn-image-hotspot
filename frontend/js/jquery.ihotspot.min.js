...
!function(a){a(document).ready(function(){a(".ihotspot_hastooltop").each(function(){a(this).data("powertip",function(){var b=a(this).parents(".ihotspot_tooltop_html").attr("data-html");return b});var b=a(this).parents(".ihotspot_tooltop_html").data("placement");a(this).powerTip({placement:b,smartPlacement:!0,mouseOnToPopup:!0})})})}(jQuery);